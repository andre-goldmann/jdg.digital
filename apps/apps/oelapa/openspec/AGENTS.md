...
6. **Follow review prompt** - run review `angular-code-review-prompt.md` to review your work before marking done
7. **Fix review issues** - Address any problems found during review
